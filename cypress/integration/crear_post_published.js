...
describe('Post E2E', () => {
    ...
    it('Ingresar con credenciales validos y crear un post con titulo usando boton "new post" y estado published', () => {
        ...
        //cy.get('.gh-contentfilter-sort',{timeout:5000}).click();
        //cy.get('ul li[data-option-index="2"]',{timeout:10000}).click();
